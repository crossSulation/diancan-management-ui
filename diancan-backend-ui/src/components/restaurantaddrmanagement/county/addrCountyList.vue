<template>
  <div>
    <el-card  class="card-item">
                  ...
                  :data="countydata">
                     <el-table-column type="expand">
                        <template scope="props">
                          <view-county :item="props.row"></view-county>
                         </template>
                    </el-table-column>
                    <el-table-column
                     width="80" 
     ...
     <edit-county v-bind:showdialog="addrCountyEditVisible"></edit-county>
     <add-county :showdialog="addrCountyAddVisible"></add-county>
</div>
</template>
<script>
import AddCounty  from "../county/addrCountyAdd.vue";
import ViewCounty from '../county/addrCountyView.vue';
import EditCounty from '../county/addrCountyEdit.vue';
export default {
  name: "county-list",
  data() {
    return {
      addrCountyEditVisible: false,
      addrCountyAddVisible: false,
      countydata: [
        {
          code: "SH",
          name: "上海市",
 ...
 computed: {},
  methods: {
    editprovince: function(index, row) {
      this.addrCountyEditVisible = true;
    },
    addnewprovince: function(index, row) {
      this.addrCountyAddVisible = true;
    },
